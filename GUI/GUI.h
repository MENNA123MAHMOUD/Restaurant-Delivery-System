...
private:
	...
	static const int	
		...
		StatusBarHeight = 250,	//Status Bar Height
...
public:
	...
	// Output Functions  ---------------------------
	void PrintMessage(string msg, string,string,string ) const; // prints a message in the status bar
	void printdynamic(string msg, int x, double y);
